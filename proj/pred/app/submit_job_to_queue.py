...
Description: 
    BASE_WWW_URL e.g. scampi.bioinfo.se
...
OPTIONS:
  ...
  -apptype  STR     Type of SCAMPI to run, SCAMPI-single or SCAMPI-msa
  -h, --help    Print this help message and exit

Created 2015-01-20, updated 2017-09-16, Nanjiang Shu
"""
usage_exp="""
Examples:
    %s -jobid rst_mXLDGD -outpath /data/result/rst_mXLDGD -datapath /data/tmp/tmp_dkgSD
"""%(progname)
...
def main(g_params):#{{{
    ...
    while i < numArgv:
        if isNonOptionArg == True:
            ...
            if argv[i] in ["-h", "--help"]:
                ...
                (app_type, i) = myfunc.my_getopt_str(argv, i)
    ...
    return SubmitJobToQueue(jobid, datapath, outpath, numseq, numseq_this_user,
            email, host_ip, base_www_url, app_type)
